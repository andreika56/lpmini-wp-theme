...
<div class="container">
  <div class="main">
    <div class="left">
      ...
      <div class="plusi">
        <div class="plus">
          <img src="<?php echo esc_url(lp_field('adv1_icon', get_template_directory_uri() . '/img/bg1/icon/1.png')); ?>" alt="" />
          <b><?php lp_the_field('adv1_text', 'С 2015 года оформили 17 439+ загранпаспортов'); ?></b>
        </div>
        <div class="plus">
          <img src="<?php echo esc_url(lp_field('adv2_icon', get_template_directory_uri() . '/img/bg1/icon/3.png')); ?>" alt="" />
          <b><?php lp_the_field('adv2_text', 'Работаем с самыми сложными случаями'); ?></b>
        </div>
        <div class="plus">
          <img src="<?php echo esc_url(lp_field('adv3_icon', get_template_directory_uri() . '/img/bg1/icon/4.png')); ?>" alt="" />
          <b><?php lp_the_field('adv3_text', 'Возможно удаленное оформление'); ?></b>
        </div>
      </div>
